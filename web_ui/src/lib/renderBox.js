 ...
 */
export const renderBoxes = (source, canvasRef, boxes_data, scores_data, classes_data, ratios) => {
  ...
  for (let i = 0; i < scores_data.length; ++i) {
    ...
    ctx.lineWidth = Math.max(Math.min(ctx.canvas.width, ctx.canvas.height) / 220, 2.5);
