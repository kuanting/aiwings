    ...
    public void onSerialPortsDetected(List<UsbSerialDevice> serialPorts) {
        ...
        for (int i = 0 ; i < serialPorts.size() ; i++){
            ...
            if(serialPorts.get(i) instanceof CDCSerialDevice){
                mHandler.obtainMessage(111, 0, 0, "CDCSerialDevice " + serialPorts.size()).sendToTarget();
                ...
                mHandler.obtainMessage(111, 0, 0, "CH34xSerialDevice " + serialPorts.size()).sendToTarget();
            ...
            else if (serialPorts.get(i) instanceof CP2102SerialDevice){
                mHandler.obtainMessage(111, 0, 0, "CP2102SerialDevice " + serialPorts.size()).sendToTarget();
            }
            else if (serialPorts.get(i) instanceof FTDISerialDevice){
                mHandler.obtainMessage(111, 0, 0, "FTDISerialDevice " + serialPorts.size()).sendToTarget();
            }
            else if (serialPorts.get(i) instanceof PL2303SerialDevice){
                mHandler.obtainMessage(111, 0, 0, "PL2303SerialDevice " + serialPorts.size()).sendToTarget();
            }
        }
    }
